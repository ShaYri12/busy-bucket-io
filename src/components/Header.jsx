...
const Header = () => {
  ...
  return (
    <div className="bg-white w-full h-[75px] ">
      <header
        className={`bg-white flex fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ease-in-out ${
          isHeaderVisible ? "translate-y-0" : "-translate-y-[75px]"
        }`}
      >
        <div className="flex max-w-[1200px] w-[1200px] mx-auto">
          <div className="relative flex flex-row w-full min-h-[75px] lg:px-[15px] justify-between items-center z-[999] bg-white">
            <div className="flex w-full justify-between lg:px-0 px-[15px] z-[999] bg-white">
              ...
              {/* Mobile Menu Button */}
              <button
                className="lg:hidden text-primary-text focus:outline-none relative w-8 h-8 flex items-center justify-center sm:px-0 mx-[3px]"
          ...
          <div
            ...
            style={
              isMenuOpen
                ? { boxShadow: "0 20px 60px rgba(55, 68, 111, .4)" }
                : {}
            }
          >
